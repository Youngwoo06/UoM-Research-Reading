...
* 2012 cutoff
	...
	outreg2 using "$tables/SharpRDD_LoA.tex", replace ctitle("2012")
	outreg2 using "$tables/SharpRDD.tex", replace ctitle("LoA")
	...
	reg adjleave_sem elig_2012_3 runvar_2012 TR2012 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean /// 
		if inrange(parent_income, 2, 5) & enter_year == 2012, robust	
	outreg2 using "$tables/SharpRDD_LoAsem.tex", replace ctitle("2012")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("Semesters")
	...
	reg GPAZ elig_2012_3 runvar_2012 TR2012 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean /// 
		if inrange(parent_income, 2, 5) & enter_year == 2012, robust
	outreg2 using "$tables/SharpRDD_GPA.tex", replace ctitle("2012")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("GPA")
	...
	* diff bandwidth
	...
	outreg2 using "$tables/SharpRDDdiffband.tex", replace ctitle("LoA")
	...
	reg adjleave_sem elig_2012_3 runvar_2012 TR2012 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean /// 
		if inrange(parent_income, 3, 4) & enter_year == 2012, robust	
	outreg2 using "$tables/SharpRDDdiffband.tex", append ctitle("Semesters")
	...
	reg GPAZ elig_2012_3 runvar_2012 TR2012 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean /// 
		if inrange(parent_income, 3, 4) & enter_year == 2012, robust
	outreg2 using "$tables/SharpRDDdiffband.tex", append ctitle("GPA")
...
* 2013 cutoff
	...
	outreg2 using "$tables/SharpRDD_LoA.tex", append ctitle("2013")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("LoA")
	...
	reg adjleave_sem elig_2013plus_456 runvar_2013 TR2013 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean ///  
		if inrange(parent_income, 5, 8) & enter_year == 2013, robust
	outreg2 using "$tables/SharpRDD_LoAsem.tex", append ctitle("2013")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("Semesters")
	...
	reg GPAZ elig_2013plus_456 runvar_2013 TR2013 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean ///  
		if inrange(parent_income, 5, 8) & enter_year == 2013, robust
	outreg2 using "$tables/SharpRDD_GPA.tex", append ctitle("2013")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("GPA")
	...
	* diff bandwidth
	...
	outreg2 using "$tables/SharpRDDdiffband.tex", append ctitle("LoA")
...
* 2015 cutoff
	...
	outreg2 using "$tables/SharpRDD_LoA.tex", append ctitle("2015")	
	outreg2 using "$tables/SharpRDD.tex", append ctitle("LoA")
	...
	reg adjleave_sem elig_2015plus_7 runvar_2015 TR2015 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean ///  
		if inrange(parent_income, 6, 8) & enter_year == 2015, robust	
	outreg2 using "$tables/SharpRDD_LoAsem.tex", append ctitle("2015")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("Semesters")
	...
	reg GPAZ elig_2015plus_7 runvar_2015 TR2015 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean ///  
		if inrange(parent_income, 6, 8) & enter_year == 2015, robust
	outreg2 using "$tables/SharpRDD_GPA.tex", append ctitle("2015")
	outreg2 using "$tables/SharpRDD.tex", append ctitle("GPA")
	...
	* diff bandwidth	
	...
	reg adjleave_sem elig_2015plus_7 runvar_2015 TR2015 ///
		...
		academic uni_found seoul seoul_metro area_matching i.hsarea_clean ///  
		if inrange(parent_income, 7, 8) & enter_year == 2015, robust	
	outreg2 using "$ables/SharpRDDdiffband.tex", append ctitle("Semesters")
